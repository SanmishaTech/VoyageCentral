...
const fetchBookings = async (
  ...
  const response = await get(
    `/group-bookings/enquiries?page=${page}&sortBy=${sortBy}&sortOrder=${sortOrder}&search=${search}&fromBookingDate=${fromBookingDate}&toBookingDate=${toBookingDate}&tourTitle=${tourTitle}&limit=${recordsPerPage}`
  );
  return response;
};

const GroupTourEnquiryList = () => {
        ...
        <CardContent>
          ...
          {isLoading ? (
            ...
            <div className="text-center text-red-500">
              Failed to load group tour enquiries.
            </div>
            ...
            <div className="text-center">No Group Tour Enquiry Found.</div>
          )}
        </CardContent>
      </Card>
...
export default GroupTourEnquiryList;
