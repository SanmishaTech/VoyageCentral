...
const GroupClientVehicleBookingList = ({
  groupBookingId,
  ...
  const { data, isLoading, isError, refetch } = useQuery({
    queryKey: ["group-client-vehicle-bookings", groupClientBookingId],
  ...
  const deleteMutation = useMutation({
    mutationFn: (id: number) => del(`/group-client-vehicle-bookings/${id}`),
    onSuccess: () => {
      ...
      <div className="mx-auto ">
        <div className="mb-1 w-full flex flex-wrap justify-between items-center gap-2">
          ...
          <Button
            ...
            onClick={() =>
              navigate(
                `/groupBookings/${groupBookingId}/groupClientBooking/${groupClientBookingId}/vehicleBooking/create`
              )
            }
                      ...
                      <TableCell className="w-20">
                        <div className="flex justify-end gap-2">
                          <Button
                            ...
                            onClick={() =>
                              navigate(
                                `/groupBookings/${groupBookingId}/groupClientBooking/${groupClientBookingId}/vehicleBooking/${vehicle.id}/edit`
                              )
                            }
                          >
                            <Edit size={16} />
...
export default GroupClientVehicleBookingList;
